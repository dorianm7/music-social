...
const ARTIST_PATH_DATA = 'M11,14C12,14 13.05,14.16 14.2,14.44C13.39,15.31 13,16.33 13,17.5C13,18.39 13.25,19.23 13.78,20H3V18C3,16.81 3.91,15.85 5.74,15.12C7.57,14.38 9.33,14 11,14M11,12C9.92,12 9,11.61 8.18,10.83C7.38,10.05 7,9.11 7,8C7,6.92 7.38,6 8.18,5.18C9,4.38 9.92,4 11,4C12.11,4 13.05,4.38 13.83,5.18C14.61,6 15,6.92 15,8C15,9.11 14.61,10.05 13.83,10.83C13.05,11.61 12.11,12 11,12M18.5,10H20L22,10V12H20V17.5A2.5,2.5 0 0,1 17.5,20A2.5,2.5 0 0,1 15,17.5A2.5,2.5 0 0,1 17.5,15C17.86,15 18.19,15.07 18.5,15.21V10Z';
const ALBUM_PATH_DATA = 'M12,11A1,1 0 0,0 11,12A1,1 0 0,0 12,13A1,1 0 0,0 13,12A1,1 0 0,0 12,11M12,16.5C9.5,16.5 7.5,14.5 7.5,12C7.5,9.5 9.5,7.5 12,7.5C14.5,7.5 16.5,9.5 16.5,12C16.5,14.5 14.5,16.5 12,16.5M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z';
...
const STORYBOOK_PATH_DATA = 'm71 3h3.8c2.1 0 4.3 0.5 5 1.2 0.9 0.9 1.2 12.7 1.2 46.9 0 40.1-0.2 45.8-1.6 46.9-1.2 1.1-7.1 1.1-31.7 0.1-37.6-1.5-39.6-1.7-40.7-4.5-0.5-1.1-1.7-20.2-2.5-42.4-1.6-41.6-1.5-44.2 2.3-44.2 0.9 0 11.6-0.7 23.7-1.5 12.1-0.8 23.9-1.5 26.3-1.5h4.2v5.5c0 5.9 0.4 6.3 3.7 4 1.8-1.3 2.2-1.3 3.3 0 2.2 2.7 3 1.6 3-4.5zm-35.5 17.2c-8 2.9-11.5 8-11.5 16.3 0 7.7 2.9 11.6 13.4 17.7 8.4 4.9 10.6 7.1 10.6 10.3 0 2.8-3.1 4.9-6 4-1.9-0.6-2.5-1.9-3.2-7-0.3-1.8-1.2-2-7.6-2.3-8.3-0.3-8.8 0.1-7.7 7.4 1.4 9.5 10.1 15.1 22.3 14.2 11.7-0.8 18.2-6.8 18.2-16.8 0-8.9-1.9-11.1-18.7-21.5-4.3-2.7-4.8-3.4-4.8-6.5 0-3.1 0.3-3.5 3-3.8 3.3-0.4 5.5 1.8 5.5 5.5 0 2.2 0.4 2.3 6.3 2.3 8.1 0 8.7-0.5 7.8-5.6-1.1-5.7-4-10.5-8-12.8-3.9-2.3-15.2-3.1-19.6-1.4z';
...
function nameToPathData(iconName) {
  ...
  switch (iconName) {
    case ARTIST_NAME:
      pathData = ARTIST_PATH_DATA;
      break;
    case ALBUM_NAME:
      pathData = ALBUM_PATH_DATA;
      break;
    case BACK_NAME:
...
const Icons = {
  ARTIST: renderIcon(ARTIST_NAME),
  ALBUM: renderIcon(ALBUM_NAME),
  ...
  PLAYLIST: renderIcon(PLAYLIST_NAME),
